    ...
    public class ScheduleViewModel : NotificationObject
    {
        ...
        private void GetFrenchAppoitments(int count)
        {
            for (int i = 0; i < count; i++)
            {
                ...
                scheduleAppointment.BackgroundColor = this.colorCollection[i];
            ...
            allDayAppointment.BackgroundColor = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#FFD80073"));
